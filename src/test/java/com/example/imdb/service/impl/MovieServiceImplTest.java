...
import com.example.imdb.model.mapping.MovieMapper;
...
import static com.example.imdb.service.impl.ActorServiceImplTest.ACTOR_FIRST_NAME;
import static com.example.imdb.service.impl.GenreServiceImplTest.GENRE_NAME;
import static com.example.imdb.service.impl.RatingServiceImplTest.RATING_COUNT_SCORES;
import static com.example.imdb.service.impl.RatingServiceImplTest.RATING_SCORES;
...
class MovieServiceImplTest {
    ...
    public void createMovieWhenMovieChangeDtoHaveGenre() {
        ...
        movieChangeDtoTest.setGenre(GENRE_NAME);
        ...
        Mockito.when(genreServiceMock.getGenre(GENRE_NAME)).thenReturn(genre);
        Mockito.when(movieRepositoryMock.save(movieTest)).thenReturn(movieTest);

        movieServiceTest.createMovie(movieChangeDtoTest);

        Assertions.assertEquals(movieTest.getGenre().getName(), GENRE_NAME);
    }
